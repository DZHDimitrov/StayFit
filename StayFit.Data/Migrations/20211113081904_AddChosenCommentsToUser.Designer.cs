...
namespace StayFit.Data.Migrations
{
    ...
    [Migration("20211113081904_AddChosenCommentsToUser")]
    partial class AddChosenCommentsToUser
    {
            ...
            modelBuilder.Entity("StayFit.Data.Models.Forum.Comment", b =>
                {
                    ...
                    b.HasOne("StayFit.Data.Models.ApplicationUser", "ChosenBy")
                        .WithMany("ChosenComments")
                        .HasForeignKey("UserId");

                    b.Navigation("ApplicationUser");

                    b.Navigation("ChosenBy");
