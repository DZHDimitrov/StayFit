...
export const LOAD_CATEGORIES_LATEST_PREVIEWS_ACTION =
  '[knowledge] load categories latest previews action';
export const LOAD_CATEGORIES_LATEST_PREVIEWS_SUCCESS =
  '[knowledge] load categories latest previews success';

export const LOAD_CONTENT_BY_MC = '[knowledge] load content by main category';
export const LOAD_CONTENT_BY_MC_SUCCESS =
  '[knowledge] load content by main category success';

export const LOAD_CONTENT_BY_SC = '[knowledge] load content by sub category';
export const LOAD_CONTENT_BY_SC_SUCCESS =
  '[knowledge] load content by sub category success';

export const LOAD_READING = '[knowledge] load reading';
export const LOAD_READING_SUCCESS = '[knowledge] load reading success';
